...
function renderGroupRow(props, groupData) {
    ...
    var isExpanded = Array.isArray(groupData.data) && groupData.data.length || _typeof(groupData.data) === 'object' && !isEmpty(groupData.data);
    var className = 'z-group-row' + (isExpanded ? ' open' : '');
