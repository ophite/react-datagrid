...
var Header = (_temp = _class = function (_React$Component) {
    ...
    this.renderMenu = function () {
        var isFilterMode = _this2.state.isFilterMode;

        var showHideFilterView = React.createElement(_menu.MenuItem, {
            onSelect: _this2.toggleFilter,
            icon: 'fiber_manual_record',
            value: !isFilterMode ? 'Show Filter' : 'Hide filter',
            caption: !isFilterMode ? 'Show Filter' : 'Hide filter'
        });
        var resetFilterView = isFilterMode ? React.createElement(_menu.MenuItem, {
            onSelect: _this2.resetFilter,
            icon: 'fiber_manual_record',
            value: 'Reset filter',
        ...
        return React.createElement(
            _menu.IconMenu,
            { icon: 'more_vert', position: 'topLeft', menuRipple: true },
            React.createElement(_menu.MenuItem, { value: 'download', icon: 'get_app', caption: 'Download' }),
            React.createElement(_menu.MenuItem, { value: 'help', icon: 'favorite', caption: 'Favorite' })
        );
    };
